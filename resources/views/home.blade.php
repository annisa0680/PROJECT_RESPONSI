...
<nav class="nav-container">
    <div class="nav-content">
        <a href="/" class="nav-logo">
            <img src="{{ asset('images/logo2.png') }}" alt="EXCoffee Corner">
        ...
        <div class="products-grid2">
            @foreach($products as $product)
                <div class="product-card">
                    ...
                    <a href="{{ route('products.show', $product->id) }}" class="btn-primary">View Details</a>
                </div>
            @endforeach
        </div>
    </div>
        ...
        <div class="categories-grid">
            @foreach($categories as $category)
                <div class="category-card">
                    ...
                    <a href="{{ route('categories.show', $category->id) }}" class="btn-primary">View Products</a>
                </div>
            @endforeach
        </div>
    </div>
